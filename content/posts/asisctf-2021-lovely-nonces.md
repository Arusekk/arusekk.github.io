...
date: 2021-10-25
author: Arusekk & haqpl
description: Unintended solution for a CTF challenge
---

# Lovely nonces (ASIS CTF Quals 2021): the unintended way

*Originally published in [justCatTheFish repo](https://github.com/justcatthefish/ctf-writeups/tree/master/2021-10-24-AsisQualsCTF2021/web_lovely_nonces).*
...
you can find the whole code in [fake-http-server.py][sol.py] (there are comments with explanation).
...
[sol.py]: https://github.com/justcatthefish/ctf-writeups/blob/master/2021-10-24-AsisQualsCTF2021/web_lovely_nonces/fake-http-server.py
